package com.wyj.app.framework.view;
...
import com.wyj.app.framework.R;


/**
 * Desc	        ${自定义没有内边距的TextView}
 *
 * https://wildma.github.io/blog/7770b02.html
 */
public class NoPaddingTextView extends AppCompatTextView {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        mRemoveFontPadding = typedArray.getBoolean(
                R.styleable.NoPaddingTextView_removeDefaultPadding, false);
        typedArray.recycle();
    }
